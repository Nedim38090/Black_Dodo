...
<nav class="navbar">
    ...
    <ul class="nav-links">
        ...
        <li class="admin-item"><a href="dashboard.php" class="btn-admin" style="color:#ffcc00; font-weight:bold; border:1px solid #ffcc00; padding:5px 10px; border-radius:4px;">PANEL ADMIN</a></li>
