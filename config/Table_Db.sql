...
CREATE TABLE articles (
                          ...
                          PRIMARY KEY (id),
                          CONSTRAINT fk_news_auteur FOREIGN KEY (utilisateurs_id) REFERENCES User(id) ON DELETE SET NULL
);
...
CREATE TABLE achats (
                        ...
                        PRIMARY KEY (id),
                        CONSTRAINT fk_achat_joueur FOREIGN KEY (utilisateur_id) REFERENCES User(id) ON DELETE CASCADE,
...
CREATE TABLE sanctions (
                           ...
                           PRIMARY KEY (id),
                           CONSTRAINT fk_sanction_joueur FOREIGN KEY (utilisateur_id) REFERENCES User(id) ON DELETE CASCADE
);